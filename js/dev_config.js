$(document).ready(function(){
	...
	$(document).on('click', '.dev_uid_up', function(){
		...
		bootbox.confirm("คุณแน่ใจที่จะเปลี่ยน Token ใช่ไหม?", function(result) {
			if(result){
			     // AJAX Request
			     $.ajax({
			       url: 'dev_config.php',
	...
	$(document).on('click', '.dev_del', function(){
		...
		bootbox.confirm("คุณแน่ใจที่จะลบรายวิชาใช่ไหม ?", function(result) {
		if(result){
		     // AJAX Request
		     $.ajax({
		       url: 'dev_config.php',
	...
	$(document).on('click', '.mode_sel', function(){
		...
		bootbox.confirm("คุณแน่ใจที่จะเปลี่ยนโหมดใช่ไหม?", function(result) {
			if(result){
			     // AJAX Request
			     $.ajax({
			       url: 'dev_config.php',
