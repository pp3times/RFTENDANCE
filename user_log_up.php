...
<div class="table-responsive" style="max-height: 500px;"> 
  <table class="table">
    <thead class="table-primary">
      <tr>
        <th style="color: white; font-weight: 500;font-size: 18px;">ID</th>
        <th style="color: white; font-weight: 500;font-size: 18px;">ชื่อ</th>
        <th style="color: white; font-weight: 500;font-size: 18px;">รหัสประจำตัว</th>
        <th style="color: white; font-weight: 500;font-size: 18px;">หมายเลขบัตร</th>
        <th style="color: white; font-weight: 500;font-size: 18px;">วิชา</th>
        <th style="color: white; font-weight: 500;font-size: 18px;">วันที่</th>
        <th style="color: white; font-weight: 500;font-size: 18px;">เวลาเข้า</th>
        <th style="color: white; font-weight: 500;font-size: 18px;">เวลาออก</th>
      </tr>
    </thead>
    <tbody class="table-secondary">
      <?php
        ...
        ?>
                  <TR>
                  <TD  style="color: black; font-weight: 500;font-size: 18px; font-family: 'Kanit',sans-serif; background-color: #aaa"><?php echo $row['id'];?></TD>
