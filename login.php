...
<main>
  <h1 class="slideInDown animated" style="font-family: 'Kanit',sans-serif!important;">กรุณาเข้าสู่ระบบด้วยรหัสแอดมิน</h1>
    ...
    <div class="login-page">
      <div class="form">
        ...
        <form class="login-form" action="ac_login.php" method="post" enctype="multipart/form-data">
          ...
          <input type="password" name="pwd" id="pwd" placeholder="รหัสผ่าน" required/>
          <button type="submit" name="login" id="login" style="background-color: black;">เข้าสู่ระบบ</button>
